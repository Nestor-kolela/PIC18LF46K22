...
const spi_master_functions_t spiMaster[] = {
    { SPI2_Close, MAC_open, SPI2_ExchangeByte, SPI2_ExchangeBlock, SPI2_WriteBlock, SPI2_ReadBlock, SPI2_WriteByte, SPI2_ReadByte, ((void*)0), ((void*)0) }
};

_Bool MAC_open(void){
    return SPI2_Open(MAC_CONFIG);
}
