...
static int atoa(FILE *fp, long double f, char c)
{
    ...
    dbuf[n++] = '0';
    dbuf[n++] = (0 ? isupper((int)c) : ((unsigned)((int)c)-'A') < 26) ? 'X' : 'x';
    ...
    while ((i < m) && (n < (80 - 5))) {
        ...
        if (!(flags & (1 << 4)) && !d && (ne < 0)) {
            ...
            if ((0 ? isupper((int)c) : ((unsigned)((int)c)-'A') < 26) && (0 ? isalpha(d) : (((unsigned)(d)|32)-'a') < 26)) {
                d = toupper(d);
            }
            dbuf[n++] = (char)d;
            --w;
    ...
    --w;
    --i;
    dbuf[i] = (0 ? isupper((int)c) : ((unsigned)((int)c)-'A') < 26) ? 'P' : 'p';
    --w;
...
static int vfpfcnvrt(FILE *fp, char *fmt[], va_list ap)
{
    ...
    if ((*fmt)[0] == '%') {
        ...
        if (!strncmp(ct, "la", ((sizeof("la")/sizeof("la"[0]))-1))) {
...
# 918 "C:\\Program Files\\Microchip\\xc8\\v2.32\\pic\\sources\\c99\\common\\doprnt.c"
        if (ct[0] == 'e') {
        ...
        if (!strncmp(ct, "le", ((sizeof("le")/sizeof("le"[0]))-1))) {
